 ...
 */
package controlador.mantenimientocliente;
...
public class ControladorMantenimientoCliente implements ActionListener, ItemListener {
    ...
    public final VentanaMantenimientoCliente ventanaMantenimientoCliente;
    ...
    public ControladorMantenimientoCliente(VentanaMantenimientoCliente ventanaMantenimientoCliente) {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == headerListadoCliente.getBuscar()) {
            ...
            if (id_actualizar == 0) {
                ...
                if (nErrores <= 0) {
                    clienteDAO.actualizar(id_actualizar, nombre, apellidop, apellidom, edad, email, direccion, telefono);
                } else {
                }
    ...
    private void llenarTabla() {
        ...
        piePaginaListadoCliente.getEtiquetaContador().setText("Mostrando " + lista.size() + " de un total de " + clienteDAO.getLeer().numeroRegistrosTabla() + " registros  ");
    }
